Public Class fStockClienteBodega
    ...
    Private Sub fStockClienteBodega_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnVer_Click(sender As Object, e As EventArgs) Handles btnVer.Click
        ...
        Grid1.RowCount = 0
        lista = n.stockClienteBodega(Me.IdEmpresa, b.id)
        n = Nothing
        Dim f As Long = 0
        For Each m In lista
            Grid1.RowCount += 1
            ...
            Grid1(f, 4).CellValue = m.Cantidad
        Next
